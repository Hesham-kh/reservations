            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ltn__form-box contact-form-box box-shadow white-bg">
                        <h4 class="title-2">  اكتب رسالتك وسنقوم بالتواصل معك</h4>
                        <form id="contact-form" action="{{route('contacts.store')}}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input-item input-item-name ltn__custom-icon">
                                        <input type="text" name="username" placeholder="ادخل اسمك">
                                    </div>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="input-item input-item-textarea ltn__custom-icon">
                                <textarea name="description" placeholder="اكتب رسالتك"></textarea>
                            </div>
