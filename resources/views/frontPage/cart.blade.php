...
<div class="wrapper">
                        ...
                        <div class="site-logo-wrap">
                            ...
                            <div class="get-support clearfix get-support-color-white">
                                ...
                                <div class="get-support-info">
                                    <h6>Get Support</h6>
                                    <h4><a href="+972597389313">+972597389313</a></h4>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="mini-cart-product-area ltn__scrollbar">
                ...
                <div class="mini-cart-item clearfix">
                    ...
                    <div class="mini-cart-info">
                        ...
                        <span class="mini-cart-quantity"> شيكل {{$cart->price}}</span>
                    </div>
                </div>
    ...
    <div class="ltn__breadcrumb-area ltn__breadcrumb-area-3 ltn__breadcrumb-color-white bg-overlay-theme-black-90 bg-image plr--9" data-bs-bg="img/bg/9.jpg">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                                    ...
                                    <div class="col-xl-4 col-sm-6 col-6">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="product-details.html"><img src="images/products/{{$cart->product->product_img}}" alt="#"></a>
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h2 class="product-title"><a href="product-details.html">{{$cart->product->name}}</a></h2>
...
<!-- Mirrored from tunatheme.com/tf/html/autixir-preview/autixir/shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 10 Dec 2022 10:45:46 GMT -->
</html>
